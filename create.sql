...
create table orders (order_id int4 not null, customer_id int4 not null, order_status boolean not null, order_type varchar(255) not null, primary key (order_id))
