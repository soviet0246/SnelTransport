...
create table article (article_id varchar(255) not null, article_color varchar(255), article_name varchar(255) not null, article_price float8 not null, article_type varchar(255), primary key (article_id))
